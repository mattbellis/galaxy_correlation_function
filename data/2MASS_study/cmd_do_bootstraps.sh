...
while ( $i < 10 )
    ...
    #echo $mcfile
        ...
        #time ../../CUDA_code/Calculate_arc_length_two_datasets $datafile $datafile out_RR_$tag.dat
        #time ../../CUDA_code/Calculate_arc_length_two_datasets $datafile $datafile out_DR_$tag.dat
